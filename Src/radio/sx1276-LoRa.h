...
extern const float LORA_SignalBw[11];
extern const uint16_t LORA_SpreadingFactor[8];

#define RF_Bw LORA_SignalBw[LoRaSettings.SignalBw]
#define RF_Sf (1 << LoRaSettings.SpreadingFactor)
...
void SX1276LoRaStartRxNoINIT(void);
/*!
